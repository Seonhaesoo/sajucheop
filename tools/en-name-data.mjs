...
export const SYLLABLES = [
  ...
  S('민', 'min', 'min', 'n', 'both', 3, [
    ...
    H('珉', '금', 'jade-like stone', '玉 jade'), H('玟', '금', 'streaked jade', '玉 jade'),
  ...
  S('아', 'a', 'ah', 'f', 'both', 3, [
    ...
    H('芽', '목', 'sprout', '艹 grass'), H('莪', '목', 'fragrant herb', '艹 grass')], 'Ah'),
  ...
  S('유', 'yu', 'yoo', 'n', 'both', 3, [
    H('裕', '목', 'abundance, ease', '衣 clothing'), H('柔', '목', 'gentle, soft', '木 tree'), H('楢', '목', 'oak', '木 tree'),
  ...
  S('우', 'u', 'oo', 'n', 'both', 3, [
    H('宇', '토', 'universe, eaves', '宀 roof'), H('堣', '토', 'corner, nook', '土 earth'), H('雨', '수', 'rain', '雨 rain'),
    H('瑀', '금', 'jade ornament', '玉 jade'), H('玗', '금', 'jade-like stone', '玉 jade'), H('訏', '금', 'grand, vast', '言 speech'), H('旴', '화', 'sunrise', '日 sun')], 'Woo'),
  ...
  S('수', 'su', 'soo', 'n', 'both', 3, [
    ...
    H('洙', '수', 'river name', '氵 water'), H('水', '수', 'water', '水 water'),
  ...
  S('예', 'ye', 'yeh', 'f', 'both', 3, [
    ...
    H('汭', '수', 'river bend', '氵 water'), H('霓', '수', 'rainbow', '雨 rain'), H('埶', '토', 'to plant', '土 earth')]),
  S('린', 'rin', 'rin', 'f', 'last', 3, [
    ...
    H('藺', '목', 'rush plant', '艹 grass'), H('橉', '목', 'tree name', '木 tree')]),
  ...
  S('온', 'on', 'ohn', 'f', 'both', 2, [
    H('溫', '수', 'warm, gentle', '氵 water'), H('穩', '목', 'calm, steady', '禾 grain'), H('榲', '목', 'tree name', '木 tree'),
  ...
  S('승', 'seung', 'sung', 'n', 'first', 3, [
    H('昇', '화', 'to rise', '日 sun'), H('陞', '토', 'to ascend, promote', '阝 mound'), H('塍', '토', 'field ridge', '土 earth'), H('陹', '토', 'to rise', '阝 mound'),
  ...
  S('혜', 'hye', 'hyeh', 'f', 'both', 3, [
    ...
    H('蕙', '목', 'orchid', '艹 grass'), H('譓', '금', 'wise', '言 speech'), H('譿', '금', 'clever', '言 speech'), H('寭', '토', 'bright', '宀 roof'), H('潓', '수', 'river name', '氵 water')]),
  ...
  S('환', 'hwan', 'hwahn', 'm', 'last', 3, [
    ...
    H('環', '금', 'ring, jade ring', '玉 jade'), H('瓛', '금', 'jade sceptre', '玉 jade'), H('皖', '금', 'morning star', '白 white'),
  ...
  S('경', 'gyeong', 'kyung', 'n', 'both', 3, [
    H('景', '화', 'scenery; bright', '日 sun'), H('慶', '화', 'celebration', '心 heart'), H('炅', '화', 'radiant', '火 fire'), H('暻', '화', 'bright', '日 sun'), H('憬', '화', 'to awaken, aspire', '忄 heart'),
    ...
    H('涇', '수', 'to flow through', '氵 water'), H('境', '토', 'realm, boundary', '土 earth'), H('逕', '토', 'path', '辶 walk'), H('坰', '토', 'open country', '土 earth')], 'Kyung'),
  S('건', 'geon', 'gun', 'm', 'both', 2, [
    ...
    H('湕', '수', 'river name', '氵 water')], 'Gun'),
  S('결', 'gyeol', 'gyul', 'n', 'last', 1, [H('潔', '수', 'clean, pure', '氵 water'), H('決', '수', 'decisive', '氵 water'), H('結', '목', 'to bind, bear fruit', '糸 silk'), H('玦', '금', 'jade ring', '玉 jade')]),
  ...
  S('석', 'seok', 'suk', 'm', 'both', 2, [
    H('錫', '금', 'tin; to bestow', '金 metal'), H('鉐', '금', 'brass', '金 metal'), H('晳', '화', 'bright', '日 sun'), H('晰', '화', 'clear, distinct', '日 sun'), H('昔', '화', 'old days', '日 sun'),
    H('析', '목', 'to analyse', '木 tree'), H('席', '목', 'seat, mat', '巾 cloth'), H('汐', '수', 'evening tide', '氵 water')], 'Suk'),
  S('철', 'cheol', 'chul', 'm', 'both', 2, [
    ...
    H('悊', '화', 'wise', '心 heart'), H('埑', '토', 'bright', '土 earth')], 'Chul'),
  ...
  S('혁', 'hyeok', 'hyuk', 'm', 'both', 2, [H('赫', '화', 'brilliant, glorious', '赤 red'), H('爀', '화', 'fiery red', '火 fire'), H('焃', '화', 'red, bright', '火 fire'), H('革', '금', 'leather; reform', '革 leather'), H('奕', '목', 'great, radiant', '大 big')], 'Hyuk'),
  ...
  S('한', 'han', 'hahn', 'n', 'both', 2, [
    H('漢', '수', 'the Han river; grand', '氵 water'), H('瀚', '수', 'vast', '氵 water'), H('澖', '수', 'wide water', '氵 water'), H('翰', '화', 'writing brush; feather', '羽 feather'),
  ...
  S('빈', 'bin', 'bin', 'n', 'last', 3, [
    ...
    H('嬪', '토', 'court lady', '女 woman'), H('邠', '토', 'an ancient state', '阝 town'), H('濱', '수', 'shore', '氵 water'), H('霦', '수', 'jade lustre', '雨 rain'),
  ...
  S('주', 'ju', 'joo', 'n', 'both', 2, [
    H('珠', '금', 'pearl', '玉 jade'), H('珘', '금', 'a jade name', '玉 jade'), H('宙', '토', 'cosmos, sky', '宀 roof'), H('姝', '토', 'pretty', '女 woman'),
  ...
  S('이', 'i', 'ee', 'f', 'both', 2, [
    H('怡', '화', 'joy, harmony', '忄 heart'), H('易', '화', 'easy; change', '日 sun'), H('珥', '금', 'jade earring', '玉 jade'), H('貽', '금', 'to bestow', '貝 shell'), H('珆', '금', 'jade-like stone', '玉 jade'),
    H('荑', '목', 'young shoots', '艹 grass'), H('苡', '목', 'Job\'s tears (a grain)', '艹 grass'), H('廙', '토', 'respectful', '广 shelter'), H('邇', '토', 'near, close', '辶 walk')], 'Yi'),
  S('인', 'in', 'een', 'n', 'both', 2, [
  ...
  S('화', 'hwa', 'hwah', 'f', 'both', 2, [
    ...
    H('嬅', '토', 'beautiful', '女 woman'), H('火', '화', 'fire', '火 fire'), H('驊', '화', 'fine horse', '馬 horse')]),
  S('향', 'hyang', 'hyahng', 'f', 'last', 1, [H('香', '목', 'fragrance', '香 fragrance (grain)'), H('鄕', '토', 'hometown', '阝 town'), H('珦', '금', 'a jade name', '玉 jade'), H('向', '수', 'to face toward', '口 mouth'), H('晑', '화', 'bright', '日 sun')]),
  ...
  S('양', 'yang', 'yahng', 'n', 'last', 1, [
    ...
    H('楊', '목', 'willow', '木 tree'), H('揚', '목', 'to raise', '手 hand'), H('暘', '화', 'sunrise', '日 sun'), H('昜', '화', 'sunshine', '日 sun')]),
  S('훤', 'hwon', 'hwon', 'f', 'last', 1, [H('萱', '목', 'daylily (forget-worry)', '艹 grass'), H('暄', '화', 'warm sunshine', '日 sun'), H('煊', '화', 'warm, bright', '火 fire'), H('烜', '화', 'bright', '火 fire')]),
  ...
  S('로', 'ro', 'roh', 'n', 'both', 2, [
    H('路', '토', 'road', '足 foot'), H('露', '수', 'dew', '雨 rain'), H('潞', '수', 'river name', '氵 water'), H('瀘', '수', 'river name', '氵 water'),
