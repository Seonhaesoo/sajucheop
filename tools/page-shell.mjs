...
export function shell(o) {
  ...
  const nav = (o.nav || []).concat(lang === 'en' ? [] : [{ href: 'http://saengil.sajucheop.com/', label: '생일첩' }, { href: 'https://dream.sajucheop.com/', label: '꿈첩' }, { href: 'https://tarot.sajucheop.com/', label: '타로첩' }]).map((n) => `<a href="${esc(n.href)}">${n.label}</a>`).join('\n      ');
  ...
  const footerLinks = lang === 'en'
    ...
    : `<a href="${o.rel}guide/">서재</a><a href="${o.rel}terms.html">이용약관</a><a href="${o.rel}privacy.html">개인정보</a><a href="http://saengil.sajucheop.com/">생일첩</a><a href="https://dream.sajucheop.com/">꿈첩</a><a href="https://tarot.sajucheop.com/">타로첩</a><a href="https://donpyo.com/">돈표</a>`;
